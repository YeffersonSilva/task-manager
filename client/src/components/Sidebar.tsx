...
const Sidebar: React.FC = () => {
  ...
  const completions = ["All", "Completed", "Pending"];
  ...
  return (
    <>
      ...
      >
        {/* Perfil */}
        <div className="flex flex-col items-center justify-center p-8 gap-2 text-white">
          ...
          <h1 className="text-xl font-semibold">{user ? user.name : "User"}</h1>
        </div>
        {/* Filtros de Prioridad */}
        <nav className="px-4 text-white flex-grow">
          <h2 className="text-md font-medium mb-3 uppercase tracking-wide flex items-center">
            <RiFilter3Line className="mr-2" /> Priority
          </h2>
          ...
          {/* Filtros de Estado de Compleción */}
          <h2 className="text-md font-medium mb-3 uppercase tracking-wide flex items-center">
        ...
        <div className="px-4 mt-auto mb-6">
          <button
            onClick={logout}
            className="flex items-center justify-center w-full py-2 px-4 bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 font-medium"
          >
