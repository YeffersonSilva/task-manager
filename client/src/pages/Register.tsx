...
const Register: React.FC = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-200 to-gray-400">
      <div className={`bg-white shadow-lg rounded-lg overflow-hidden w-full max-w-lg transition-all duration-500 transform ${isLogin ? 'translate-x-full' : ''}`}>
        <div className="p-8">
